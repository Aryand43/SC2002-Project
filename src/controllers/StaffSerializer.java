 ...
 * <p>
 * 
 * Responsible for converting CareerCenterStaff objects to and from their string representation to the correct<br>
 * format to be written back into the file, as well as providing file related metadata such as filepath and header.<br><br>
...
public class StaffSerializer implements Serializer<CareerCenterStaff>{
	 ...
	 * new instance of CareerCenterStaff  by separting the line by commas into: <br>
	 * <ol>
	 * <li>StaffID</li>
	 * <li>Name</li>
	 * <li>Role</li>
